...
root.geometry("370x460+600+300")

val=""

data=StringVar()

display=Entry(root,textvariable=data,bd=34,justify="right",bg="powder blue",font=("ariel",20))
display.grid(row=0,columnspan=4)

btnc=Button(root,text="C",font=("Ariel",12,"bold"),bg="orange",bd=12,height=2,width=6,command=btnClear)
btnc.grid(row=1,column=0)
btn_per=Button(root,text="%",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=lambda:btnClick('%'))
...
btn_dot=Button(root,text=".",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=lambda:btnClick('.'))
...
btn_00=Button(root,text="00",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=lambda:btnClick(00))
btn_00.grid(row=5,column=1)
btn_equal=Button(root,text="=",font=("Ariel",12,"bold"),bg="orange",bd=12,height=2,width=15,command=btnEquals)
btn_equal.grid(row=5,column=2,columnspan=20)
